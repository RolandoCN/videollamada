    ...
    <div>
        <div class="container">
            <div class="row">
                            ...
                            <tr v-for="user in allusers" :key="user.id">
                                ...
                                <td>
                                    <div class="btn-group" role="group">                                        
                                        <button class="btn btn-danger" style="margin-right:7px" @click="deleteProduct(user.id)">Eliminar</button>
                                        <button type="button" class="btn btn-warning mr-2" v-for="user in allusers"
                                            :key="user.id" @click="placeVideoCall(user.id, user.name)">
                                            Llamar                                             
                                        </button>
                                    </div>
                                </td>
                ...
                <div class="col">
                    <button type="button" class="btn btn-warning mr-2" v-for="user in allusers" :key="user.id"               @click="placeVideoCall(user.id, user.name)">
                        Llamar 
                    </button>
                </div>
            ...
            <div class="row mt-5" id="video-row">
                <div class="col-12 video-container" v-if="callPlaced">
                    ...
                    <div class="action-btns">
                        ...
                        {{ mutedAudio ? "Unmute" : "Mute" }} </button>
                        <button type="button" class="btn btn-primary mx-4" @click="toggleMuteVideo" >
                        {{ mutedVideo ? "ShowVideo" : "HideVideo" }} </button>
                        <button type="button" class="btn btn-danger" @click="endCall"> EndCall</button>
                    </div>
